...
export default {
  head: 
    <>
      ...
      <meta property="og:title" content="Wallet-API Documentation" />
      <meta property="og:description" content="Wallet-API official Documentation" />
    ...
    <span style={{marginLeft: '5px'}}>Wallet-API</span>
    </div>,
    project: {
    ...
    chat: {
      ...
      useNextSeoProps() {
        ...
        if (asPath === '/') {
          return {
            titleTemplate: 'Wallet-API - Documentation'
          }
        }
        const word = asPath.split('/')[1];
        const capitalizedWord = word.charAt(0).toUpperCase() + word.slice(1);
        return {
          titleTemplate: `Wallet-API - ${capitalizedWord}`
        }
      },
      footer: {text: <div style={{ width: "100%", display: "grid", placeItems:"center"}}>

<svg style={{fill: "currentColor", marginBottom: "20px"}}
 version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="200px" viewBox="0 0 2000.58 669.35">
<path d="M1711.35,627.2v42.14h289.22V479.29h-42.14V627.2H1711.35z M1711.35,0v42.14h247.08v147.92h42.14V0H1711.35z M1562.2,326
