...
- `transaction` (required): The transaction object in the currency family-specific format.
- `options` (optional): Extra parameters that might be needed for the transaction.
