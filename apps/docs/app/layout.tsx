...
export const metadata: Metadata = {
  title: {
    default: "Wallet-API - Documentation",
    template: "Wallet-API - %s",
  },
  description: "Wallet-API official Documentation",
  icons: {
    icon: { url: "/img/favicon.ico", type: "image/svg+xml" },
  },
  openGraph: {
...
const navbar = (
  <Navbar
    logo={logo}
    projectLink="https://github.com/ledgerhq/wallet-api"
    ...
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body>
        <Layout
          ...
          docsRepositoryBase="https://github.com/LedgerHQ/wallet-api/tree/main/apps/docs"
