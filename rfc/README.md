...
related to the design and implementation of the Platform API, for which no
...
the Platform API, but those decisions must be recorded separately in issues and PRs.

As a rule of thumb, if you can articulate a specific question that needs to be
answered, write an issue. If you need to explore the topic and get input from
