...
| apiVersion       | Specific manifest schema version | string          | *                           |
| manifestVersion  | Version supported by the app that the wallet needs to implement in order to support | enum            | 2                           |
| categories       | Category related to your Live App | Array(string)   | items: min 1 → *        |
...
| type             | Type of you Live app | enum            | "dapp", "walletApp", "webBrowser" |
| [params](#params) | ___| Object          | depend on the type          |
| visibility       | Visibility of your live app inside Ledger Live | string          | "complete", "searchable", "deep"  |
...
_Exemple of a complete manifest.json file :_
