...
The `useWalletInfo` hook is part of the Ledger Wallet API Client for React. It allows the user to fetch the wallet information associated with the connected wallet. This documentation provides a detailed explanation of how to use this hook in your application.
...
- `walletInfo`: The wallet information object or `null` if not fetched. This information might include things like balance, currency, addresses, etc.
