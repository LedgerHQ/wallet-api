...
<img src="/developer_mode_tab.png" alt="screenshot of the Developer tab" title="Developer tab" />
...
<img src="/platform_dev_tools.png" alt="screenshot of the Platform dev tools" title="Developer tools window" />
